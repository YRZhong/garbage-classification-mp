<template>
  <div class="test">
    <van-search :value="searchParams" placeholder="请输入垃圾名称" @change="onChange" @search="onSearch" />
    <van-card
      class="card"
          ...
          .then(res => {
            if (res.code === 1) {
              ...
              //有结果 跳转展示
                ...
                wx.navigateTo({
                  url: "../search/main?res=" + JSON.stringify(res.data)
                });
              }
            } else {

  ...
  <div class="main-container">
    ...
    <div class="img-group">
      <div class="img" v-for="item in answerImg" :key="item.name">
        <img style="height: 300rpx; width: 300rpx" :src="item.url" @click="handleAnswerClick(item.value)" />
...
export default {
  ...
  methods: {
    ...
    handleAnswerClick(value) {
      ...
      setTimeout(() => {this.tansitionShow = true}, 500);
      setTimeout(() => {
        ...
        if (this.percentage < 100) {
          ...
          wx.redirectTo({url: '../result/main?res=' + this.points + '&mistakes=' + JSON.stringify(this.mistakes)})
        } 
      }, 500)  
    }
  }
